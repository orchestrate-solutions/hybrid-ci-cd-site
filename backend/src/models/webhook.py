...
class WebhookEvent(TypedDict):
    ...
    SECURITY: payload field removed to prevent secret leakage.
    Only metadata (extracted fields) is stored. payload_hash provides
    ...
    payload_hash: str          # SHA-256 hash of original payload (for audit/verification)
