...
export class MarketplaceService {
   ...
   * Disabled for now to allow static export to build
   */
  async loadFromGitHub(): Promise<void> {
    console.log('[MarketplaceService] GitHub loading disabled for static export');
    // Future: implement when dynamic pages are available
    return;
  }
